...
The original Eclipse Temurin and Amazon Corretto images have vulnerabilities, but the `dhi.io` variants have 0 vulnerabilities for both Eclipse Temurin and Amazon Corretto. 
